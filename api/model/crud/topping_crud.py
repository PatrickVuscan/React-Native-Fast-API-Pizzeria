...
class ToppingCRUD:
    ...
    @classmethod
    def get_toppings(cls, dbb: Session):
        raise NotImplementedError

    @classmethod
    def get_topping_by_id(cls, dbb: Session, topping_id: int):
        raise NotImplementedError

    @classmethod
    def create_topping(cls, dbb: Session, topping: ToppingCreate):
        raise NotImplementedError

    @classmethod
    def update_topping(cls, dbb: Session, topping: ToppingUpdate):
        raise NotImplementedError

    @classmethod
    def delete_topping(cls, dbb: Session, topping_id: int):
        raise NotImplementedError
...
class SqlToppingCRUD(ToppingCRUD):
    ...
    @classmethod
    def delete_topping(cls, dbb: Session, topping_id: int):
        topping = cls.get_topping_by_id(dbb, topping_id)
        dbb.delete(topping)
